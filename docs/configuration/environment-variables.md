...
| Object storage | `S3_ENABLED` (default `false`), `S3_REGION`, `S3_BUCKET`, `S3_ALIAS_HOST`, `S3_ENDPOINT`, `AWS_ACCESS_KEY_ID`, `AWS_SECRET_ACCESS_KEY` | Conditional | S3-compatible file storage. Access key and secret are secrets. |
