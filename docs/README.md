...
5. [free_monitoring_setup.md](free_monitoring_setup.md) — Guide to deploy a free monitoring stack (Prometheus, Grafana, PgHero, lograge) locally and on AWS ECS/EKS/Fargate.
